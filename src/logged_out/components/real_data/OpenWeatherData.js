...
import {
  Box, Button, withStyles, Card, IconButton, Menu, MenuItem, Grid, withWidth, isWidthDown, isWidthUp,
...
const CustomizedDot = (props) => {
  ...
  return (
    <svg fill={stroke} viewBox="0 0 1024 1024" x={cx + 5} y={cy - 0} width={600} height={600} overflow="visible" >
      <g>
        <path
...
function HourlyForecast(props) {
  ...
  return (
    <>
      ...
      <Box height={isWidthDown('md', width) ? 200 : height} width="100%" display="flex"
        style={{
          backgroundColor: theme.palette.common.black,
          userSelect: "none",
        }}
      ...
      >
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart
            margin={{ bottom: 5, top: 20, left: -25, right: -55 }}
      ...
      >
        ...
        >
          ...
          <Legend
            ...
            verticalAlign="top" //{isWidthUp("md", width) ? "top" : "bottom"}
            wrapperStyle={isWidthUp("md", width) ? { fontSize: 12 } : {width: "200px", fontSize: 12, left: 80, position: "sticky" }}
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
            onClick={handleClick}
          />
